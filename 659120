    ...
    Title = "Stormy.cc v1"; -- 
    Text = "Please be patient while we load the Script Resources.."; -- 
    ...
    local cfglocation = "Stormy.cfg/"      
    makefolder("Stormy.cfg")      
    ...
    local MainUIColor = COL3RGB(82, 9, 228)    
    ...
    function library:New(name)      
        ...
        TextLabel.BackgroundColor3 = COL3RGB(82, 9, 228)  
        ...
        TextLabel.Text = name  
        TextLabel.TextColor3 = COL3RGB(82, 9, 228)  
        TextLabel.TextSize = 13.000  
        TextLabel.TextXAlignment = Enum.TextXAlignment.Left  

        TabButtons.Name = "TabButtons"  
        TabButtons.Parent = Menu  
        TabButtons.BackgroundColor3 = COL3RGB(82, 9, 228)  
        ...
        Tabs.Name = "Tabs"  
        Tabs.Parent = Menu  
        Tabs.BackgroundColor3 = COL3RGB(82, 9, 228)  
        ...
        function menu:Tab(text)  
            ...
            TabGui.Name = "TabGui"  
            TabGui.Parent = Tabs  
            TabGui.BackgroundColor3 = COL3RGB(82, 9, 228)  
            ...
            Left.Name = "Left"  
            Left.Parent = TabGui  
            Left.BackgroundColor3 = COL3RGB(82, 9, 228)  
            ...
            Right.Name = "Right"  
            Right.Parent = TabGui  
            Right.BackgroundColor3 = COL3RGB(82, 9, 228)  
    ...
    makefolder("Stormy.lua")      

    local allluas = {}  

    for _,lua in pairs(listfiles("Stormy.lua")) do  
        local luaname = GSUB(lua, "Stormy.lua\\", "")  
        INSERT(allluas, luaname)  
    end  

    RunService.RenderStepped:Wait()      

    local gui = library:New("Stormy.cc")      
    ...
    luascripts:Element("Button", "load", {}, function()  
        loadstring(readfile("Stormy.lua\\"..values.luas["lua scripts"].lua.Scroll))()  
    end)  
    ...
    local function AddLegit(Tab)      
        ...
        Tab:Element("Slider", "field of view", {min = 30, max = 720, default = 120})      
    ...
    local function AddRage(Tab)      
        ...
        Tab:Element("Slider", "minimum damage", {min = 0, max = 250, default = 20})      
        Tab:Element("Slider", "max fov", {min = 1, max = 720, default = 180})      
    end      
    ...
    antiaim:Element("Dropdown", "pitch", {options = {"none", "up", "down", "Among", "180", "funny", "Bs", "Bsv2", "Bsv3", "random", "God", "fucker", "cool", "cool2", "back"}})  
    ...
    antiaim:Element("Slider", "High poss", {min = -2, max = 37, default = 2})
    ...
    chat:Element("Slider", "speed (ms)", {min = 5, max = 1000, default = 500})      
    ...
    --136801964 
    animations:Element("Dropdown", "animation", {options = {"floss", "default", "Sit", "Under", "sleep", "top", "Fake walk", "Fake swim", "Fake jump", "Dolphin", "Monkey" ,"Around Town", "Baby Dance", "Old Town Road", "Line Dance", "Happy", "Dorky Dance", "Hero Landing", "Jacks"}}, function(tbl)  
        Dance.AnimationId = tbl.Dropdown == "floss" and "rbxassetid://5917459365" or tbl.Dropdown == "default" and "rbxassetid://3732699835" or tbl.Dropdown == "Sit" and "rbxassetid://507768133" or tbl.Dropdown == "Under" and "rbxassetid://3576719440" or tbl.Dropdown == "sleep" and "rbxassetid://7690987462" or tbl.Dropdown == "top" and "rbxassetid://3361276673"or tbl.Dropdown == "Fake swim" and "rbxassetid://616119360" or tbl.Dropdown == "Fake walk" and "rbxassetid://1330180905" or tbl.Dropdown == "Fake jump" and "rbxassetid://896586529" or tbl.Dropdown == "Dolphin" and "rbxassetid://5918726674" or tbl.Dropdown == "Monkey" and "rbxassetid://3333499508" or tbl.Dropdown == "Around Town" and "rbxassetid://3303391864" or tbl.Dropdown == "Baby Dance" and "rbxassetid://4265725525" or tbl.Dropdown == "Old Town Road" and "rbxassetid://5937560570" or tbl.Dropdown == "Line Dance" and "rbxassetid://4049037604" or tbl.Dropdown == "Happy" and "rbxassetid://4841405708"  or tbl.Dropdown == "Dorky Dance" and "rbxassetid://4212455378" or tbl.Dropdown == "Hero Landing" and "rbxassetid://5104344710" or tbl.Dropdown == "Jacks" and "rbxassetid://3338066331" 
    ...
    RunService.RenderStepped:Connect(function(step)     
        ...
        if values.rage.angles["body roll"].Dropdown == "-262" then  
                ...
                local Pitch = values.rage.angles["pitch"].Dropdown == "none" and 0 or values.rage.angles["pitch"].Dropdown == "up" and 1 or values.rage.angles["pitch"].Dropdown == "down" and -1 or values.rage.angles["pitch"].Dropdown == "Among" and 15 or values.rage.angles["pitch"].Dropdown == "funny" and 20 or values.rage.angles["pitch"].Dropdown == "Bs" and math.huge -5/0 -1 or values.rage.angles["pitch"].Dropdown == "Bsv2" and 23 or values.rage.angles["pitch"].Dropdown == "cool2" and -13 or values.rage.angles["pitch"].Dropdown == "cool" and 12 or values.rage.angles["pitch"].Dropdown == "back" and -92 or values.rage.angles["pitch"].Dropdown == "God" and 15 or values.rage.angles["pitch"].Dropdown == "fucker" and -13 or values.rage.angles["pitch"].Dropdown == "random" and RANDOM(-100, 100)/10 or 2.5  
    ...
    LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current)      
        ...
        if values.misc.chat["kill say"].Toggle then      
            game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat["message"].Text ~= "" and values.misc.chat["message"].Text or "Super Idol的笑容都沒你的甜八月正午的陽光都沒你耀眼熱愛 105 °C的你滴滴清純的蒸餾水你不知道你有多可愛跌倒後會傻笑著再站起來你從來都不輕言失敗對夢想的執著一直不曾更改很安心 當你對我說不怕有我在放著讓我來勇敢追自己的夢想那堅定的模樣", false, "Innocent", false, true)  
        end      
    end)      
    ...
    Print("Credits to Rainy.solution for Ambient, Bloxfun LUA, Rejoin LUA, Trail, and SendNotification.")
    Print("Credits to MexicanHook for Making CreateHitElement, Noclip, Fakeframe, Crash Server, and ChatScript.")
    Print("Credits to Lunarsense DEV for making Time Changer, and Underground AA that works.")
    Print("Credits to Bads_Stormy for Making the Prediction Better.")
    Print("This script was Pasted from Bads_Stormy, MexicanHook, Lunarsense, Rainy.solutions Features.")

    wait(1.2)
    game.StarterGui:SetCore("SendNotification", {
    Title = "Stormy.cc v1"; -- 
    Text = "Successfully Loaded! Have a Great Game!"; -- 
    Icon = "rbxassetid://1297630667"; -- t
    Duration = 5; -- 
    })

    ChatScript.moveOldMessages()
    ChatScript.createNewMessage("Stormy.cc","Stormy.cc v1 has Successfully Loaded!",MainUIColor,Color3.new(1,1,1),0.01,nil)
    ChatScript.moveOldMessages()
    ChatScript.createNewMessage("Stormy.cc","Build: DEV",MainUIColor,Color3.new(1,1,1),0.01,nil)
    ChatScript.moveOldMessages()
    ChatScript.createNewMessage("Stormy.cc","Current Version: 0.1.3",MainUIColor,Color3.new(1,1,1),0.01,nil)
